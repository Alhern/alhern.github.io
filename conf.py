...
BLOG_AUTHOR = "Alhern"  # (translatable)
BLOG_TITLE = "A quality noob blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://alhern.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://alhern.github.io/"
BLOG_EMAIL = "audev@protonmail.com"
BLOG_DESCRIPTION = "Et élucubrations diverses."  # (translatable)
